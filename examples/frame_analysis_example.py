...
def main2():
    ...
    try:
        ...
        bcs = [
            ...
            BoundaryCondition(nodes[1], False, False, False, False, False, False),  # Fixed base
            BoundaryCondition(nodes[2], True, True, True, False, False, False)  # Roller support at the top of vertical member
        ]
